...
| Qwen Image 2.1 Fun ControlNet | [Alibaba PAI公式重み・条件画像](https://huggingface.co/alibaba-pai/Qwen-Image-2.1-Fun-Controlnet-Union)、[KijaiのINT8変換](https://huggingface.co/Kijai/QwenImage_experimental/tree/04987755e10002ff33e4ea307a811487dddd79d9/model_patches)、[VideoX-Funの制御実装](https://github.com/aigc-apps/VideoX-Fun/blob/67e3b4b8184ae8ff61ab3e3fbdb68bb817f41515/videox_fun/models/qwenimage21_transformer2d_control.py) | 重みと条件画像は[Qwen Research License](docs/assets/qwen-image21-fun-controlnet/LICENSE.qwen-research.txt)（非商用）、VideoX-FunのコードはApache-2.0。重みはGitに含めません。作例に同梱した条件画像の出典と帰属は[NOTICE](docs/assets/qwen-image21-fun-controlnet/NOTICE)を参照してください。 |
